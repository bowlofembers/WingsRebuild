        ...
        private static class WingStrategy<T extends Animator> implements Strategy {
            ...
            public void ifFormPresent(Consumer<FormRenderer> consumer) {
                consumer.accept(new FormRenderer() {
                    ...
                    @Override
                    public void render(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha, float delta) {
                        WingStrategy.this.shape.getModel().render(WingStrategy.this.animator, delta, poseStack, buffer, packedLight, packedOverlay, red, green, blue, alpha);
                    }
                });
            }
        }
